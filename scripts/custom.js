...
function getArticle(request) {
    ...
    $.ajax({ // ajax call starts
        url: 'https://proj.ruppin.ac.il/bgroup54/test2/tar1/WebService.asmx/GetArticle',   // server side web service method
    ...
    function init_template() {//Class is vital to run AJAX Pages 
        ...
        if (window.location.href.toString().indexOf('allphotos.html') != -1) {
            ...
            function getPhotos() {
                ...
                $.ajax({ // ajax call starts
                    url: 'https://proj.ruppin.ac.il/bgroup54/test2/tar1/WebService.asmx/GetPhotos',   // server side web service method
                    //data: dataString,                          // the parameters sent to the server
                    type: 'POST',                              // can be also GET
                    dataType: 'json',                          // expecting JSON datatype from the server
                    contentType: 'application/json; charset = utf-8', // sent to the server
        ...
        if (window.location.href.toString().indexOf('pref1.html') != -1) {
            ...
            function checkUser(request) {
                ...
                $.ajax({ // ajax call starts
                    url: 'https://proj.ruppin.ac.il/bgroup54/test2/tar1/WebService.asmx/checkUser',   // server side web service method
            ...
            $.ajax({ // ajax call starts
                url: 'https://proj.ruppin.ac.il/bgroup54/test2/tar1/WebService.asmx/GetCategories',   // server side web service method
                //data: dataString,                          // the parameters sent to the server
                type: 'POST',                              // can be also GET
                dataType: 'json',                          // expecting JSON datatype from the server
                contentType: 'application/json; charset = utf-8', // sent to the server
            ...
            function updateCategories(request) {
                ...
                $.ajax({ // ajax call starts
                    url: 'https://proj.ruppin.ac.il/bgroup54/test2/tar1/WebService.asmx/UpdateCategories',   // server side web service method
                    data: dataString,                          // the parameters sent to the server
                    type: 'POST',                              // can be also GET
                    dataType: 'json',                          // expecting JSON datatype from the server
                    contentType: 'application/json; charset = utf-8', // sent to the server
        ...
        if (window.location.href.toString().indexOf('pref2.html') != -1) {
            ...
            function updateUserPref(request) {
                ...
                $.ajax({ // ajax call starts
                    url: 'https://proj.ruppin.ac.il/bgroup54/test2/tar1/WebService.asmx/UpdateUserPrefs',   // server side web service method
                    data: dataString,                          // the parameters sent to the server
                    type: 'POST',                              // can be also GET
                    dataType: 'json',                          // expecting JSON datatype from the server
                    contentType: 'application/json; charset = utf-8', // sent to the server
